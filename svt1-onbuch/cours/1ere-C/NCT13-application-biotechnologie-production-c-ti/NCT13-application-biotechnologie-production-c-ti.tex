% Application de la biotechnologie dans la production de biens et services — SVT 1ère C — Cours signé OnBuch+
...
\pagegarde{Application de la biotechnologie dans la production de biens et services}{SVT}{1ère C}{Module 4 : La Biotechnologie}{NCT13}{3 h}{Cette leçon présente la biotechnologie, ses définitions et ses grands domaines d'application (agroalimentaire, santé, environnement). Elle distingue les biotechnologies traditionnelles (fermentation) des biotechnologies modernes (sélection assistée, biotechnologies enzymatiques) et ouvre la réflexion sur leurs enjeux économiques et éthiques.
\vspace{4pt}
