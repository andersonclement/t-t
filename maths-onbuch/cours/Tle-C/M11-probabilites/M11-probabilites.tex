% Probabilités, variables aléatoires et loi binomiale — Mathématiques Tle C — Cours signé OnBuch+
...
\node {}
child { node {$\bar{A}$}
  child { node {$\bar{B}$ \\ $P(\bar{A}\cap\bar{B})$} edge from parent node[below,pos=0.6]{$P_{\bar{A}}(\bar{B})$} }
  child { node {$B$ \\ $P(\bar{A}\cap B)$} edge from parent node[above,pos=0.6]{$P_{\bar{A}}(B)$} }
  edge from parent node[below,pos=0.6]{$P(\bar{A})$} }
child { node {$A$}
  child { node {$\bar{B}$ \\ $P(A\cap\bar{B})$} edge from parent node[below,pos=0.6]{$P_A(\bar{B})$} }
  child { node {$B$ \\ $P(A\cap B)$} edge from parent node[above,pos=0.6]{$P_A(B)$} }
...
\begin{bilan}[L'essentiel de la leçon M11 — Probabilités et Loi Binomiale]
