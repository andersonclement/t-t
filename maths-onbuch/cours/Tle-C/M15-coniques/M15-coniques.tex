% Coniques — Mathématiques Tle C — Cours signé OnBuch+
...
\pagegarde{Coniques}{Mathématiques}{Tle C}{Configurations et transformations élémentaires du plan}{15}{28 h}{Cette leçon présente les coniques (ellipse, parabole, hyperbole) comme sections planes d'un cône de révolution, puis par leur définition monofocale MF = e·d(M,D). Elle conduit à leurs équations réduites, à leurs éléments caractéristiques, à leurs tangentes et à la reconnaissance d'équations du second degré, avec des applications concrètes (antennes, orbites, ponts).
\vspace{4pt}
