% Primitives d'une fonction continue — Mathématiques Tle C — Cours signé OnBuch+
...
\pagegarde{Primitives d'une fonction continue}{Mathématiques}{Tle C}{Relations et opérations fondamentales dans l'ensemble des nombres réels}{05}{5 h}{Cette leçon introduit la notion de primitive d'une fonction continue sur un intervalle, opération inverse de la dérivation. Elle fournit les tableaux de primitives usuelles et les techniques de reconnaissance des formes composées (u′·uʳ, u′/u, u′eᵘ) indispensables pour le calcul intégral et les équations différentielles du programme de Terminale.
\vspace{4pt}
