% Suites numériques — Mathématiques Tle TI — Cours signé OnBuch+
...
\pagegarde{Suites numériques}{Mathématiques}{Tle TI}{Relations et opérations fondamentales dans l'ensemble des nombres réels}{04}{8 h}{Cette leçon introduit le raisonnement par récurrence et les outils d'étude des suites : monotonie, bornitude, convergence des suites monotones bornées. Elle aboutit à l'étude complète des suites récurrentes uₙ₊₁ = f(uₙ) et à l'encadrement numérique de leur limite par l'inégalité des accroissements finis, compétence phare du Bac C, D, E et TI.
\vspace{4pt}
