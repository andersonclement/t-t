...
\node[racine, align=center]{Quelle est l'opération\\principale de $f$ ?}
  child { node[branche]{Quotient\\$f = \dfrac{u}{v}$}
    child { node[formule]{$f' = \dfrac{u'v - uv'}{v^2}$\\si $u$ \text{non constante}} }
    child { node[formule]{$f' = -\dfrac{k\,v'}{v^2}$\\si $f = \dfrac{k}{v}$} }
  }
  child { node[branche]{Produit\\$f = u \times v$}
    child { node[formule]{$f' = u'v + uv'$\\si $u$ \text{non constante}} }
    child { node[formule]{$f' = k\,u'$\\si $f = k\,u$} }
  }
  child { node[branche]{Somme\\$f = u + v$}
    child { node[formule]{$f' = u' + v'$\\(\text{terme à terme})} }
  };
\end{tikzpicture}
\end{center}
