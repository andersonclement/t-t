% Théorie des graphes — Mathématiques Tle E — Cours signé OnBuch+
...
\begin{enumerate}
  ...
  \item Prendre $MO(12)$. Relie $M$ à $O$. $A_T=\{OS, YM, ST, MO\}$. (Composante : $\{Y,M,O,S,T\}$). Tous sommets atteints ? Non, 5 sommets $\to$ 4 arêtes. \textbf{STOP}.
\end{enumerate}
...
\textbf{2. Kruskal.} Tri : $Q_5Q_6(4), Q_1Q_2(5), Q_2Q_3(6), Q_3Q_4(7), Q_4Q_5(9), Q_1Q_3(8), Q_2Q_4(10), Q_4Q_6(11), Q_3Q_5(12)$.
Sélection : $Q_5Q_6(4)$, $Q_1Q_2(5)$, $Q_2Q_3(6)$, $Q_3Q_4(7)$, $Q_4Q_5(9)$ $\to$ cycle $Q_3-Q_4-Q_5-Q_6$ ? Non, $Q_6$ pas encore relié au reste. Attendez.
Arêtes triées : 4, 5, 6, 7, 8, 9, 10, 11, 12.
