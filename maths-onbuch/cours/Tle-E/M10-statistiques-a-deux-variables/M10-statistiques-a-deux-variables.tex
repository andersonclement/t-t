% Statistiques à deux variables — Mathématiques Tle E — Cours signé OnBuch+
...
\pagegarde{Statistiques à deux variables}{Mathématiques}{Tle E}{Organisation et gestion des données}{10}{9 h}{Cette leçon introduit l'étude simultanée de deux caractères statistiques : représentation par nuage de points, ajustement affine (méthodes de Mayer et des moindres carrés), mesure de la corrélation et prévisions. Elle constitue un chapitre central de l'épreuve de mathématiques au Baccalauréat C, D, E et TI.
\vspace{4pt}
