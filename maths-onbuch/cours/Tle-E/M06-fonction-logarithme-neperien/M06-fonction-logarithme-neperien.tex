% Fonction logarithme népérien — Mathématiques Tle E — Cours signé OnBuch+
...
5. \textbf{Courbe :} Symétrique par rapport à $x=1$ (car $u$ symétrique). Point bas $(1;0)$. Pas d'asymptote verticale. Asymptote parabolique ? Non, $\ln(x^2) \sim 2\ln|x|$.
\end{exoresolu}
...
3. $x\to\pm\infty \Rightarrow u\sim x^2 \to +\infty \Rightarrow f\to +\infty$. Asymptote parabolique ? $f(x) - 2\ln|x| \to \ln 1 = 0$. Courbe au-dessus de l'axe $x$ (minimum 0), symétrique axe $x=2$, point $(2;0)$.
