#!/usr/bin/env python3
"""Pipeline de génération des cours signés OnBuch+ (SVTEEHB, Terminale D).
...
Contraintes : 4 à 7 sections ; chaque section a 4 à 10 points de contenu précis, au moins 1 illustration pertinente quand c'est naturel (graphique, schéma géométrique, arbre), et 3 à 6 boîtes pédagogiques."""
    txt = llm([{"role": "system", "content": "Tu es un inspecteur pédagogique de SVT au MINESEC (Cameroun) et concepteur de cours premium. Tu réponds uniquement en JSON valide."},
