% Champ magnétique, force de Lorentz et force de Laplace — Physique Tle C — Cours signé OnBuch+
...
\pagegarde{Champ magnétique, force de Lorentz et force de Laplace}{Physique}{Tle C}{Module 2 : Mouvements et interactions — évolutions temporelles des systèmes mécaniques}{P04}{5 h}{Cette leçon introduit le champ magnétique, ses sources (aimants et courants) et ses effets sur les charges en mouvement (force de Lorentz) et sur les conducteurs parcourus par un courant (force de Laplace). Elle aboutit aux applications technologiques majeures : haut-parleur, moteur électrique et définition de l'ampère.
\vspace{4pt}
