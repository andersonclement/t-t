% Aspect ondulatoire de la lumière : diffraction, interférences et effet Doppler — Physique Tle C — Cours signé OnBuch+
...
\pagegarde{Aspect ondulatoire de la lumière : diffraction, interférences et effet Doppler}{Physique}{Tle C}{Module 4 : Onde, matière et transformations nucléaires}{P16}{5 h}{Cette leçon établit le caractère ondulatoire de la lumière à travers deux phénomènes fondamentaux : la diffraction par une fente ou un fil, et les interférences à deux ondes avec le dispositif des fentes de Young. Elle se conclut par une étude qualitative de l'effet Doppler et de ses applications, du radar routier à l'expansion de l'Univers.
\vspace{4pt}
