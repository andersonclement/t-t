% Oscillateurs mécaniques — Physique Tle E — Cours signé OnBuch+
...
\pagegarde{Oscillateurs mécaniques}{Physique}{Tle E}{Module 2 : Mouvements et interactions — évolutions temporelles des systèmes mécaniques}{P09}{7 h}{Cette leçon étudie les oscillateurs mécaniques : pendule élastique, pendule simple et pendule de torsion. Elle établit les équations différentielles du mouvement, détermine les grandeurs caractéristiques (période, pulsation, amplitude, phase), analyse l'énergie mécanique et introduit les oscillations amorties, forcées et le phénomène de résonance.
\vspace{4pt}
