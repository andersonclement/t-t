...
\draw[popcurve, thick, domain=2.5:12.5, samples=200, variable=\x] plot ({\x}, {0.8*sin(3*pi*(\x-2.5)/10)});
\draw[popcurve, thick, domain=2.5:12.5, samples=200, variable=\x, dashed] plot ({\x}, {-0.8*sin(3*pi*(\x-2.5)/10)});
% Longueur L
...
% Enveloppes
\addplot[popgreen!50, thick, domain=0:1.5] {2*sin(2*pi*x/0.5)}; % lambda=0.5
\addplot[popgreen!50, thick, domain=0:1.5] {-2*sin(2*pi*x/0.5)};
% Instants t=0 (cos=1) et t=T/4 (cos=0)
\addplot[popblue, very thick, domain=0:1.5] {2*sin(2*pi*x/0.5)*1}; % t=0
\addplot[poporange, very thick, domain=0:1.5, dashed] {2*sin(2*pi*x/0.5)*0}; % t=T/4
% Instants t=T/8 (cos=sqrt(2)/2)
\addplot[poppurple, thick, domain=0:1.5] {2*sin(2*pi*x/0.5)*0.707};
\addplot[poppink, thick, domain=0:1.5] {2*sin(2*pi*x/0.5)*(-0.707)};
% Nœuds
...
\begin{tikzpicture}[scale=0.8, every node/.style={font=\small}]
    ...
    \draw[popblue, very thick, domain=0:12, samples=200, smooth] plot (\x, {2*sin(\x*pi/4)});
