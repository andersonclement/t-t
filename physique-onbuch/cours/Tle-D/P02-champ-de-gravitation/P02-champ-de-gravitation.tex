% Interaction gravitationnelle et champ de gravitation — Physique Tle D — Cours signé OnBuch+
...
\pagegarde{Interaction gravitationnelle et champ de gravitation}{Physique}{Tle D}{Module 2 : Mouvements et interactions — évolutions temporelles des systèmes mécaniques}{P02}{4 h}{Cette leçon établit la loi de l'attraction universelle de Newton et introduit la notion de champ de gravitation créé par un point matériel ou une sphère homogène. Elle aboutit à l'expression du champ de gravitation terrestre en fonction de l'altitude et à la distinction entre poids et force de gravitation.
\vspace{4pt}
