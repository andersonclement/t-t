% Mouvement dans le champ de pesanteur uniforme — Physique Tle D — Cours signé OnBuch+
...
\pagegarde{Mouvement dans le champ de pesanteur uniforme}{Physique}{Tle D}{Module 2 : Mouvements et interactions — évolutions temporelles des systèmes mécaniques}{P06}{6 h}{Cette leçon étudie les mouvements des projectiles et des mobiles dans le champ de pesanteur uniforme : chute libre, tir parabolique et mouvement sur plan incliné. Elle fournit les outils mathématiques (équations horaires, trajectoire, flèche, portée) indispensables pour résoudre les problèmes classiques du Baccalauréat C.
\vspace{4pt}
