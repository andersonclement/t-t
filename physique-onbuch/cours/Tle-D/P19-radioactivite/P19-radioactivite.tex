% La radioactivité et la loi de décroissance — Physique Tle D — Cours signé OnBuch+
...
\pagegarde{La radioactivité et la loi de décroissance}{Physique}{Tle D}{Module 4 : Onde, matière et transformations nucléaires}{P19}{5 h}{Cette leçon étudie le noyau atomique, sa cohésion (énergie de liaison, courbe d'Aston) et ses transformations spontanées : la radioactivité α, β⁻, β⁺ et γ. Elle établit et exploite la loi de décroissance radioactive, outil fondamental de la datation et des applications médicales et industrielles.
\vspace{4pt}
