% Les lentilles minces — Physique 1ère TI — Cours signé OnBuch+
...
\pagegarde{Les lentilles minces}{Physique}{1ère TI}{Module 3 : Optique}{N07}{8 h}{Cette leçon étudie les lentilles minces : définition, éléments caractéristiques (foyers, vergence, distance focale), conditions de Gauss et constructions géométriques des images. Elle établit et exploite les formules de position et de grandissement, le théorème des vergences, et présente des applications concrètes (loupe, œil, appareil photographique).
\vspace{4pt}
