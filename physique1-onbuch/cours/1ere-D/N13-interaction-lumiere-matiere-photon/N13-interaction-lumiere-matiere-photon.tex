% Interaction lumière-matière : le photon — Physique 1ère D — Cours signé OnBuch+
...
\pagegarde{Interaction lumière-matière : le photon}{Physique}{1ère D}{Module 3 : Optique}{N13}{7 h}{Cette leçon introduit le modèle corpusculaire de la lumière et la quantification de l'énergie pour expliquer comment la matière émet, absorbe et diffuse la lumière. Elle fournit les outils (E = hν, λ = c/ν, diagrammes de niveaux d'énergie) pour interpréter les spectres et déterminer la température d'un corps chaud par analyse spectrale.
\vspace{4pt}
