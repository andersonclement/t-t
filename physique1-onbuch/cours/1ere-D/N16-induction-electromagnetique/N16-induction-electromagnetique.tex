% Induction électromagnétique — Physique 1ère D — Cours signé OnBuch+
...
\pagegarde{Induction électromagnétique}{Physique}{1ère D}{Module 4 : Aspects énergétiques des circuits électriques}{N16}{5 h}{Cette leçon introduit le phénomène d'induction électromagnétique : définition du flux magnétique, loi de Lenz, expression de la force électromotrice induite et phénomène d'auto-induction dans une bobine. Elle fournit les outils de calcul (flux, f.é.m. induite, inductance) indispensables pour comprendre alternateurs, transformateurs et l'interprétation énergétique des circuits.
\vspace{4pt}
