% Point de fonctionnement d'un circuit et loi de Pouillet — Physique 1ère C — Cours signé OnBuch+
...
\pagegarde{Point de fonctionnement d'un circuit et loi de Pouillet}{Physique}{1ère C}{Module 4 : Aspects énergétiques des circuits électriques}{N15}{4 h}{Cette leçon introduit la notion de point de fonctionnement d'un circuit électrique et la loi de Pouillet, en s'appuyant sur les composants usuels (résistor, diode, transistor). Elle permet de déterminer graphiquement et analytiquement le point de fonctionnement et de calculer la puissance dans des circuits simples.
\vspace{4pt}
