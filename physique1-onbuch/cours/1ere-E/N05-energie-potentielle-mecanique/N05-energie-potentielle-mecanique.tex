% Énergie potentielle et énergie mécanique — Physique 1ère E — Cours signé OnBuch+
...
\pagegarde{Énergie potentielle et énergie mécanique}{Physique}{1ère E}{Module 2 : Mouvements et interactions mécaniques}{N05}{4 h}{Cette leçon introduit l'énergie potentielle (de pesanteur et élastique) et l'énergie mécanique d'un système. Elle établit le principe de conservation de l'énergie mécanique et montre comment le travail des forces non conservatrices explique les situations de non conservation (freinage, chocs).
\vspace{4pt}
