% L'œil réduit : fonctionnement, défauts et correction — Physique 1ère E — Cours signé OnBuch+
...
\pagegarde{L'œil réduit : fonctionnement, défauts et correction}{Physique}{1ère E}{Module 3 : Optique}{N08}{8 h}{Cette leçon modélise l'œil humain par un système optique simple, l'œil réduit, afin d'expliquer la vision nette et le phénomène d'accommodation. Elle permet ensuite d'identifier les défauts de l'œil (myopie, hypermétropie, presbytie) et de proposer les corrections par lentilles adaptées.
\vspace{4pt}
