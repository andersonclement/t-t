...
Les programmes de Terminale C, D et E sont identiques : le contenu est le
...
def assemble(L, serie):
    ...
    tex = (
        ...
        f"% Programme officiel MINESEC, Terminale C, D, E. Compiler avec : tectonic {L['id']}-{L['slug']}.tex\n"
