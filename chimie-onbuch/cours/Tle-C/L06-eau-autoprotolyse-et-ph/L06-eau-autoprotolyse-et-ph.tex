% Acides et bases en solution aqueuse : eau, autoprotolyse et pH — Chimie Tle C — Cours signé OnBuch+
...
\begin{corrige}[QCM : l'eau et le pH]
\begin{enumerate}
    \item \textbf{b.} Par définition $K_e = [\ce{H3O+}][\ce{OH-}] = 10^{-7} \times 10^{-7} = 10^{-14}$ à \SI{25}{\celsius}.
    \item \textbf{b.} À \SI{25}{\celsius}, pH < 7 $\Rightarrow$ solution acide.
    \item \textbf{b.} Géométrie coudée (angle \approx 104,5°) et moment dipolaire non nul $\Rightarrow$ polaire.
    \item \textbf{c.} Dilution 10 fois $\Rightarrow$ $[\ce{H3O+}]$ divisé par 10 $\Rightarrow$ pH augmente de 1 unité : $2 + 1 = 3$.
    \item \textbf{b.} $[\ce{H3O+}] = 10^{-3,5} = \num{3,16e-4} \approx \SI{3,2e-4}{mol.L^{-1}}$.
\end{enumerate}
\end{corrige}
...
\begin{enumerate}
    \item \textbf{Vrai.} À \SI{25}{\celsius}, p$K_e = 14$, neutralité $\Leftrightarrow$ pH = 7.
    \item \textbf{Faux.} À \SI{60}{\celsius}, p$K_e = 13,0$. Eau pure $\Rightarrow$ $[\ce{H3O+}] = [\ce{OH-}] = 10^{-6,5}$ $\Rightarrow$ pH = 6,5. C'est la définition de la neutralité à cette température.
    \item \textbf{Faux.} $K_e = [\ce{H3O+}][\ce{OH-}] \neq 0$. Si $[\ce{OH-}]$ augmente, $[\ce{H3O+}]$ diminue mais reste non nul (ex. $10^{-10}$ M).
    \item \textbf{Vrai.} $K_e = 10^{-14}$ très petit $\Rightarrow$ équilibre très déplacé vers les réactifs (eau moléculaire).
    \item \textbf{Vrai.} $\text{pH} = -\log[\ce{H3O+}]$. Fonction décroissante : pH $\downarrow \Rightarrow [\ce{H3O+}] \uparrow$.
    \item \textbf{Faux.} Papier pH : précision \approx 0,5. pH-mètre étalonné : précision \approx 0,01-0,1.
\end{enumerate}
\end{corrige}
...
\begin{enumerate}
    \item $\text{pH} = -\log_{10}\left(\frac{[\ce{H3O+}]}{\SI{1}{mol.L^{-1}}}\right)$. Valide pour $[\ce{H3O+}] < \SI{1}{mol.L^{-1}}$ (solution diluée).
    \item $\ce{2 H2O(l) <=> H3O+(aq) + OH-(aq)}$ ; $K_e = [\ce{H3O+}][\ce{OH-}]$.
    \item $\text{p}K_e = -\log_{10} K_e$. À \SI{25}{\celsius}, $\text{p}K_e = 14,0$.
    \item Couple \ce{H3O+}/\ce{H2O} : \ce{H2O} est la \textbf{base} (capte \ce{H+}). Couple \ce{H2O}/\ce{OH-} : \ce{H2O} est l'\textbf{acide} (donne \ce{H+}).
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Solution d'acide chlorhydrique]
\begin{enumerate}
    \item $[\ce{H3O+}] = 10^{-2,7} = \SI{2,0e-3}{mol.L^{-1}}$.
    $[\ce{OH-}] = \frac{K_e}{[\ce{H3O+}]} = \frac{\num{1,0e-14}}{\num{2,0e-3}} = \SI{5,0e-12}{mol.L^{-1}}$.
    \item Acide fort $\Rightarrow$ dissociation totale : $C = [\ce{H3O+}] = \SI{2,0e-3}{mol.L^{-1}}$.
    \item \textbf{Majoritaire :} \ce{H2O} (\approx \SI{55,5}{mol.L^{-1}}). \textbf{Mineures :} \ce{H3O+}, \ce{Cl-} (\approx \SI{2e-3}{mol.L^{-1}}). \textbf{Ultra-minoritaire :} \ce{OH-} (\SI{5e-12}{mol.L^{-1}}).
    \item Électroneutralité : $[\ce{H3O+}] = [\ce{Cl-}] + [\ce{OH-}]$.
    $[\ce{Cl-}] = C = \SI{2,0e-3}{M}$. $[\ce{OH-}] = \SI{5,0e-12}{M} \ll [\ce{Cl-}]$.
    $[\ce{H3O+}] \approx [\ce{Cl-}] = \SI{2,0e-3}{M}$. L'équation est vérifiée.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Dilution d'une solution de soude]
\begin{enumerate}
    \item $F = \frac{V}{V_0} = \frac{200,0}{20,0} = 10$.
    \item $C = \frac{C_0}{F} = \frac{0,050}{10} = \SI{5,0e-3}{mol.L^{-1}}$.
    \item Base forte $\Rightarrow$ $[\ce{OH-}] = C = \SI{5,0e-3}{mol.L^{-1}}$.
    $[\ce{H3O+}] = \frac{K_e}{[\ce{OH-}]} = \frac{\num{1,0e-14}}{\num{5,0e-3}} = \SI{2,0e-12}{mol.L^{-1}}$.
    $\text{pH} = -\log(\num{2,0e-12}) = 11,7$ (ou $\text{pOH} = -\log(\num{5,0e-3}) = 2,30 \Rightarrow \text{pH} = 14,0 - 2,30 = 11,70$).
    \item \textbf{Protocole :} Rincer la pipette jaugée \SI{20}{mL} avec la solution mère. Prélever \SI{20,0}{mL} (poire à pipeter). Verser dans la fiole jaugée \SI{200}{mL} (rincée eau distillée). Rincer la pipette au-dessus de la fiole. Compléter à l'eau distillée jusqu'au trait de jauge (bas ménisque). Bouchonner, homogénéiser.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[L'eau pure à \SI{60}{\celsius}]
\begin{enumerate}
    \item Dans l'eau pure, la seule source d'ions est l'autoprotolyse : $\ce{2 H2O <=> H3O+ + OH-}$. Les coefficients stœchiométriques sont 1:1, donc à l'équilibre $[\ce{H3O+}] = [\ce{OH-}]$, à toute température.
    \item $[\ce{H3O+}] = [\ce{OH-}] = \sqrt{K_e} = 10^{-\text{p}K_e/2} = 10^{-6,5} = \SI{3,16e-7}{mol.L^{-1}}$.
    $\text{pH} = -\log(10^{-6,5}) = 6,5$.
    \item \textbf{Faux.} L'eau pure reste \textbf{neutre} car $[\ce{H3O+}] = [\ce{OH-}]$. La neutralité est définie par l'égalité des concentrations, pas par pH = 7 (valeur seulement vraie à \SI{25}{\celsius}). À \SI{60}{\celsius}, neutralité $\Leftrightarrow$ pH = 6,5.
    \item $K_e$ \textbf{augmente} avec la température (p$K_e$ diminue). D'après le principe de Le Chatelier, si la température favorise le sens direct (produits), la réaction est \textbf{endothermique} (absorbe la chaleur).
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Le pH du sang]
\begin{enumerate}
    \item pH = 7,35 $\Rightarrow [\ce{H3O+}] = 10^{-7,35} = \SI{4,47e-8}{mol.L^{-1}}$.
    pH = 7,45 $\Rightarrow [\ce{H3O+}] = 10^{-7,45} = \SI{3,55e-8}{mol.L^{-1}}$.
    \item $K_e = 10^{-13,6} = \SI{2,51e-14}{}$.
    Pour pH 7,35 : $[\ce{OH-}] = \frac{\num{2,51e-14}}{\num{4,47e-8}} = \SI{5,61e-7}{mol.L^{-1}}$.
    Pour pH 7,45 : $[\ce{OH-}] = \frac{\num{2,51e-14}}{\num{3,55e-8}} = \SI{7,07e-7}{mol.L^{-1}}$.
    \item $[\ce{OH-}] > [\ce{H3O+}]$ (environ 10 à 20 fois plus). Le sang est un milieu \textbf{basique} (légèrement). Neutralité à \SI{37}{\celsius} : pH = 6,8.
    \item Acidose : pH diminue. Comme $\text{pH} = -\log[\ce{H3O+}]$, une diminution de pH correspond à une \textbf{augmentation} de $[\ce{H3O+}]$.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Type Bac — Trois solutions et indicateurs colorés]
\begin{enumerate}
    \item \textbf{Calculs (à \SI{25}{\celsius}, $K_e=10^{-14}$) :}
    \begin{center}
    \begin{tabular}{|c|c|c|c|}
    \hline
    \rowcolor{popblueL} \textbf{Solution} & \textbf{pH} & \textbf{$[\ce{H3O+}]$ (\SI{}{mol.L^{-1}})} & \textbf{$[\ce{OH-}]$ (\SI{}{mol.L^{-1}})} \\
    \hline
    pH 3,0 & 3,0 & $10^{-3,0} = \num{1,0e-3}$ & $10^{-11,0} = \num{1,0e-11}$ \\
    pH 7,0 & 7,0 & $10^{-7,0} = \num{1,0e-7}$ & $10^{-7,0} = \num{1,0e-7}$ \\
    pH 11,0 & 11,0 & $10^{-11,0} = \num{1,0e-11}$ & $10^{-3,0} = \num{1,0e-3}$ \\
    \hline
    \end{tabular}
    \end{center}
    \item \textbf{Teintes des indicateurs :}
    \begin{center}
    \begin{tabular}{|c|c|c|c|}
    \hline
    \rowcolor{popblueL} \textbf{Indicateur} & \textbf{Solution pH 3,0} & \textbf{Solution pH 7,0} & \textbf{Solution pH 11,0} \\
    \hline
    Hélianthine (3,1-4,4) & pH < 3,1 $\rightarrow$ \textbf{Rouge} & pH > 4,4 $\rightarrow$ \textbf{Jaune orangé} & pH > 4,4 $\rightarrow$ \textbf{Jaune orangé} \\
    \hline
    BBT (6,0-7,6) & pH < 6,0 $\rightarrow$ \textbf{Jaune} & pH $\in$ [6,0; 7,6] $\rightarrow$ \textbf{Vert (mélange)} & pH > 7,6 $\rightarrow$ \textbf{Bleu} \\
    \hline
    Phénolphtaléine (8,2-10,0) & pH < 8,2 $\rightarrow$ \textbf{Incolore} & pH < 8,2 $\rightarrow$ \textbf{Incolore} & pH > 10,0 $\rightarrow$ \textbf{Rose fuchsia} \\
    \hline
    \end{tabular}
    \end{center}
    \item \textbf{Analyse :}
    \begin{itemize}
        \item Hélianthine : Ne distingue pas pH 7,0 et 11,0 (toutes deux jaune orangé).
        \item Phénolphtaléine : Ne distingue pas pH 3,0 et 7,0 (toutes deux incolore).
        \item BBT : Distingue les trois (Jaune, Vert, Bleu).
    \end{itemize}
    \textbf{Méthode proposée :} Utiliser l'\textbf{hélianthine} (ou phénolphtaléine) qui sépare la solution acide (pH 3) des deux autres.
    \begin{enumerate}
        \item Ajouter quelques gouttes d'hélianthine dans chaque flacon.
        \item Le flacon qui devient \textbf{rouge} est la solution pH 3,0 (acide).
        \item Les deux autres flacons sont jaune orangé (pH 7,0 et 11,0).
        \item \textbf{Mesure complémentaire :} Tremper une bandelette de \textbf{papier pH} (ou utiliser le pH-mètre) dans chacun des deux flacons restants. Celui indiquant pH \approx 7 est la solution neutre, l'autre (pH \approx 11) est la solution basique.
    \end{enumerate}
    \item \textbf{Solution pH 3,0 (HCl) :} Acide fort $\Rightarrow C = [\ce{H3O+}] = 10^{-3,0} = \SI{1,0e-3}{mol.L^{-1}}$.
    \textbf{Préparation pH 4,0 :} Cible $C' = 10^{-4,0} = \SI{1,0e-4}{mol.L^{-1}}$, $V' = \SI{500,0}{mL}$.
    Relation de dilution : $C V_0 = C' V' \Rightarrow V_0 = \frac{C' V'}{C} = \frac{\num{1,0e-4} \times 500,0}{\num{1,0e-3}} = \SI{50,0}{mL}$.
    \textbf{Protocole :} Pipette jaugée \SI{50,0}{mL} (rincée solution mère) $\rightarrow$ prélever \SI{50,0}{mL} HCl $\rightarrow$ verser dans fiole jaugée \SI{500,0}{mL} (rincée eau distillée) $\rightarrow$ compléter eau distillée au trait de jauge $\rightarrow$ homogénéiser. \textbf{Sécurité :} Verser l'acide dans l'eau, porter lunettes/blouse/gants.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Type Bac — Le jus de bissap, indicateur naturel]
\textbf{Partie A}
\begin{enumerate}
    \item pH 2,0 (acide) $\rightarrow$ \textbf{Rouge}. pH 7,0 (neutre) $\rightarrow$ \textbf{Violet}. pH 12,0 (basique) $\rightarrow$ \textbf{Vert-bleu}.
    \item \begin{center}
        \begin{tabular}{|c|c|c|c|}
        \hline
        \rowcolor{popblueL} \textbf{pH} & \textbf{$[\ce{H3O+}]$} & \textbf{$[\ce{OH-}]$} \\
        \hline
        2,0 & $\num{1,0e-2}$ & $\num{1,0e-12}$ \\
        7,0 & $\num{1,0e-7}$ & $\num{1,0e-7}$ \\
        12,0 & $\num{1,0e-12}$ & $\num{1,0e-2}$ \\
...
\begin{enumerate}
\setcounter{enumi}{2}
    \item Teinte rouge $\Rightarrow$ pH \textbf{inférieur à 3,1} (zone de virage bissap non donnée mais rouge = acide fort comme étalon pH 2). Valeur approchée : \textbf{pH $\approx 2,0$}. $[\ce{H3O+}] \approx \SI{1,0e-2}{mol.L^{-1}}$.
    \item $\ce{CH3COOH(aq) + H2O(l) <=> CH3COO-(aq) + H3O+(aq)}$ (transformation limitée, flèche d'équilibre).
    \item \textbf{Non.} Pour un acide fort (HCl), dissociation totale : $C_{\ce{HCl}} = [\ce{H3O+}]$. Pour l'acide éthanoïque (faible), réaction limitée : $[\ce{H3O+}] < C_{\ce{CH3COOH}}$. Une partie seulement des molécules a réagi. $C_{\ce{CH3COOH}} = [\ce{CH3COOH}]_{eq} + [\ce{CH3COO-}]_{eq} > [\ce{H3O+}]_{eq}$.
\end{enumerate}
\textbf{Partie C}
\begin{enumerate}
\setcounter{enumi}{5}
    ...
    \begin{itemize}
        \item Jus de bissap : Qualitatif, comparaison visuelle, précision \approx \pm 1 à 2 unités de pH (dépend de l'œil, concentration indicateur).
        \item Papier pH : Semi-quantitatif, lecture par comparaison nuancier, précision \approx \pm 0,5 unité.
        \item pH-mètre étalonné : Quantitatif, mesure potentiométrique, précision \approx \pm 0,01 à 0,1 unité.
    \end{itemize}
    \textbf{Conclusion :} Pour un dosage (suivi précis d'équivalence), le \textbf{pH-mètre étalonné} est indispensable. Le papier pH convient pour un contrôle rapide. Le bissap reste pédagogique ou pour usage domestique.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Type Bac — Préparation d'une solution d'acide éthanoïque]
\textbf{Partie A}
\begin{enumerate}
    \item $[\ce{H3O+}] = 10^{-3,0} = \SI{1,0e-3}{mol.L^{-1}}$.
    \item Hypothèse acide fort : $C = [\ce{H3O+}] = \SI{1,0e-3}{mol.L^{-1}}$.
    \item $F = \frac{C_0}{C} = \frac{1,0}{\num{1,0e-3}} = 1000$.
    $V_0 = \frac{V}{F} = \frac{250,0}{1000} = \SI{0,250}{mL} = \SI{250}{\micro L}$.
    \begin{attention}
    Volume trop faible pour une pipette jaugée classique (minimum \SI{1}{mL}). Il faut réaliser une \textbf{dilution en deux temps} (dilution mère 1/10 puis 1/100) ou utiliser une micropipette si disponible.
    \end{attention}
    \textbf{Protocole réaliste (dilution en deux temps) :}
    \begin{enumerate}
        \item \textbf{Étape 1 (1/10) :} Pipette \SI{10,0}{mL} $S_0$ $\rightarrow$ Fiole \SI{100,0}{mL}$\rightarrow$ Compléter eau $\rightarrow$ Solution $S_1$ ($C_1 = \SI{0,10}{mol.L^{-1}}$).
        \item \textbf{Étape 2 (1/100) :} Pipette \SI{2,50}{mL} $S_1$ (ou \SI{25,0}{mL} si fiole 250 mL) $\rightarrow$ Fiole \SI{250,0}{mL}$\rightarrow$ Compléter eau $\rightarrow$ Solution $S$ ($C = \SI{1,0e-3}{mol.L^{-1}}$).
        \item \textbf{Sécurité :} Lunettes, blouse, gants. Manipuler sous hotte si possible. \textbf{Verser l'acide dans l'eau} (jamais l'inverse). Rincer verrerie à l'eau en cas de projection.
    \end{enumerate}
\end{enumerate}
\textbf{Partie B}
\begin{enumerate}
\setcounter{enumi}{4}
    \item pH $\approx 3$ (acide) $\Rightarrow$ Teinte \textbf{Rouge} (couleur forme acide de l'indicateur bissap).
    \item \textbf{Non, le pH réel sera \textbf{supérieur} à 3,0 (moins acide).}
    \textbf{Justification :} Acide faible $\Rightarrow$ dissociation partielle : $\ce{CH3COOH + H2O <=> CH3COO- + H3O+}$.
    $K_a = \frac{[\ce{CH3COO-}][\ce{H3O+}]}{[\ce{CH3COOH}]} \approx \frac{[\ce{H3O+}]^2}{C}$ (si $\tau$ faible).
    $[\ce{H3O+}] \approx \sqrt{K_a C} = \sqrt{10^{-4,8} \times 10^{-3}} = \sqrt{10^{-7,8}} = 10^{-3,9} \approx \SI{1,3e-4}{M}$.
    pH r\'eel $\approx 3,9 > 3,0$. La concentration en \ce{H3O+} est plus faible que prévu car l'acide ne se dissocie pas totalement.
    \item \textbf{Ajustement au pH-mètre :}
    \begin{enumerate}
        \item Étalonner le pH-mètre (tampons pH 4, 7).
        \item Plonger l'électrode dans la solution S (agitation magnétique).
        \item Si pH mesuré $> 3,0$ (trop basique) : ajouter \textbf{goutte à goutte} de la solution mère S$_0$ (ou solution plus concentrée) jusqu'à pH = 3,0.
        \item Si pH mesuré $< 3,0$ (trop acide) : ajouter \textbf{goutte à goutte} de l'eau distillée jusqu'à pH = 3,0.
        \item Noter le volume final si ajustement par eau (nouvelle concentration).
    \end{enumerate}
\end{enumerate}
\end{corrige}
