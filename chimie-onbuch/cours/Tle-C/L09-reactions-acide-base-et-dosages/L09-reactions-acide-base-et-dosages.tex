...
\begin{corrige}[QCM : l'équivalence acido-basique]
\textbf{1. b)} C'est la définition même de l'équivalence. Le pH = 7 seulement pour fort/fort (a faux). L'indicateur change de couleur à l'équivalence, il n'est pas incolore (c faux).
\textbf{2. b)} Réaction $\ce{H3O+ + OH- -> 2H2O}$, totale, neutre à l'équivalence.
\textbf{3. b)} Propriété fondamentale : $\mathrm{pH}_{1/2} = \mathrm{p}K_a$.
\textbf{4. c)} $\mathrm{pH}_E \approx 8,7$ se situe dans la zone de virage de la phénolphtaléine (8,2--10,0).
\end{corrige}
...
\begin{enumerate}
\item \textbf{Faux.} La réaction $\ce{H3O+ + OH- -> 2H2O}$ est \textbf{rapide} (quasi instantanée) et \textbf{exothermique} (dégage de la chaleur, $\Delta_r H^\circ < 0$).
\item \textbf{Vrai.} À l'équivalence, il ne reste que l'acide conjugué de la base faible (ex: \ce{NH4+}), qui hydrolyse l'eau : $\ce{NH4+ + H2O <=> NH3 + H3O+}$, d'où $\mathrm{pH} < 7$.
\item \textbf{Vrai.} On trace les tangentes aux branches montantes (ou descendantes) et à la branche verticale ; leurs intersections projetées sur l'axe des abscisses donnent $V_E$.
\item \textbf{Faux.} L'indicateur est bien choisi si sa \textbf{zone de virage contient le pH à l'équivalence} ($\mathrm{pH}_E$), pas le pH initial.
\item \textbf{Vrai.} À la demi-équivalence, la demi-quantité d'acide a réagi : $n_{\ce{CH3COOH}} = n_{\ce{CH3COO-}}$, donc concentrations égales (même volume total). D'après Henderson-Hasselbalch, $\mathrm{pH} = \mathrm{p}K_a + \log(1) = \mathrm{p}K_a$.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Définitions et équations]
\begin{enumerate}
\item L'équivalence acido-basique est l'état du système pour lequel les quantités de matière d'acide et de base introduites sont dans les proportions stœchiométriques de l'équation-bilan. Pour $\ce{AH + B ->}$ produits (coeff. 1:1) : $n_{AH}(\text{initial}) = n_B(\text{versé à l'équivalence})$, soit $C_A V_A = C_B V_{BE}$.
\item a) $\ce{H3O+ + OH- -> 2H2O}$ (ou $\ce{HCl + NaOH -> NaCl + H2O}$).\\
      b) $\ce{CH3COOH + OH- -> CH3COO- + H2O}$.\\
      c) $\ce{NH3 + H3O+ -> NH4+ + H2O}$ (ou $\ce{NH3 + HCl -> NH4Cl}$).
\item Le point de demi-équivalence correspond au volume de titrant versé égal à la moitié du volume équivalent ($V_{1/2} = V_E/2$). En ce point, pour un couple acide faible/base forte, $\mathrm{pH} = \mathrm{p}K_a$ de l'acide faible.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Volume équivalent d'un dosage simple]
\begin{enumerate}
\item $\ce{CH3COOH_{(aq)} + OH-_{(aq)} -> CH3COO-_{(aq)} + H2O_{(l)}}$
\item À l'équivalence : $n_{\ce{CH3COOH}} = n_{\ce{OH-}} \Rightarrow C_A V_A = C_B V_{BE}$.
      $V_{BE} = \dfrac{C_A V_A}{C_B} = \dfrac{0,080 \times 15,0}{0,10} = \SI{12,0}{mL}$.
\item \textbf{Demi-équivalence :} $V_{B1/2} = 6,0\ \text{mL}$, $\mathrm{pH}_{1/2} = \mathrm{p}K_a = \textbf{4,8}$.
      \textbf{Équivalence :} $\mathrm{pH}_E > 7$. \emph{Justification :} À l'équivalence, la solution ne contient que l'acétate \ce{CH3COO-}, base conjuguée de l'acide éthanoïque. Elle hydrolyse l'eau : $\ce{CH3COO- + H2O <=> CH3COOH + OH-}$, ce qui rend la solution basique.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Prévision d'une courbe de dosage]
\begin{enumerate}
\item $\ce{NH3_{(aq)} + H3O+_{(aq)} -> NH4+_{(aq)} + H2O_{(l)}}$
\item $C_B V_B = C_A V_{AE} \Rightarrow V_{AE} = \dfrac{0,10 \times 25,0}{0,10} = \SI{25,0}{mL}$.
\item On verse de l'acide dans une base : le pH \textbf{diminue}. À l'équivalence, il ne reste que \ce{NH4+} (acide conjugué de \ce{NH3}), qui hydrolyse : $\ce{NH4+ + H2O <=> NH3 + H3O+}$. Le pH est \textbf{inférieur à 7}.
      \emph{Calcul de vérification :} $C_{\ce{NH4+}} = \frac{0,10 \times 25}{50} = 0,050\ \text{M}$. $K_a = 10^{-9,2}$. $[\ce{H3O+}] \approx \sqrt{K_a C} = \sqrt{10^{-9,2} \times 0,05} \approx 5,6 \times 10^{-6}\ \text{M} \Rightarrow \mathrm{pH}_E \approx 5,25$.
\item $\mathrm{pH}_E \approx 5,25$. Parmi les indicateurs proposés, seul l'\textbf{hélianthine} a une zone de virage acide (3,1--4,4). Bien que sa zone ne contienne pas exactement 5,25 (idéalement rouge de méthyle 4,4--6,2), c'est le \textbf{seul choix possible} parmi la liste pour un dosage acide fort / base faible. Le BBT et la phénolphtaléine virent en domaine basique, bien après l'équivalence.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Exploitation d'un tableau de mesures]
\begin{enumerate}
\item \emph{Courbe tracée : points alignés sur deux branches (lente puis verticale) avec un saut net entre 14 et 16 mL.}
\item \textbf{Méthode des tangentes :} Branche avant-saut (0--14 mL) et branche après-saut (16--20 mL) sont quasi horizontales. Tangente au point d'inflexion (vers 15 mL) verticale. Intersections $\rightarrow V_{BE} = \SI{15,0}{mL}$. $\mathrm{pH}_E = 7,0$ (donné par le tableau, milieu du saut).
\item $C_A V_A = C_B V_{BE} \Rightarrow C_A = \dfrac{C_B V_{BE}}{V_A} = \dfrac{0,10 \times 15,0}{20,0} = \SI{0,075}{mol.L^{-1}}$.
\item \textbf{Oui.} Le saut de pH s'étend de $\approx 2,9$ (14 mL) à $\approx 11,0$ (16 mL). Il \textbf{contient} la zone de virage du BBT (6,0 -- 7,6) et le $\mathrm{pH}_E = 7,0$. Le changement de couleur du BBT (jaune $\to$ bleu) sera net et coïncidera avec l'équivalence.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Les trois flacons sans étiquette]
\begin{enumerate}
\item \textbf{Protocole :} Pour chaque flacon, prélever $V = \SI{20,0}{mL}$ (pipette jaugée) dans un bécher. Plonger une électrode pH-métrique étalonnée. Titrer :
      \begin{itemize}
      \item Flacons suspects "acides" : par soude \ce{NaOH} \SI{0,10}{M} (burette).
      \item Flacon suspect "base" : par acide chlorhydrique \ce{HCl} \SI{0,10}{M} (burette).
      \end{itemize}
      Suivre le pH après chaque ajout (ex: \SI{1}{mL} puis \SI{0,2}{mL} près du saut). Tracer $\mathrm{pH} = f(V_{\text{titrant}})$.
\item \textbf{Flacon 1 (HCl) + NaOH :} pH croissant. Saut vertical important centré sur $V_E = 20,0\ \text{mL}$. $\mathrm{pH}_E = 7$ (\textbf{égal à 7}).
      \textbf{Flacon 2 (CH3COOH) + NaOH :} pH croissant. Saut moins vertical, centré sur $V_E = 20,0\ \text{mL}$. $\mathrm{pH}_E > 7$ (\textbf{supérieur à 7}, $\approx 8,7$). Point de demi-équivalence visible à $10,0\ \text{mL}$, $\mathrm{pH} \approx 4,8$.
      \textbf{Flacon 3 (NH3) + HCl :} pH \textbf{décroissant}. Saut centré sur $V_E = 20,0\ \text{mL}$. $\mathrm{pH}_E < 7$ (\textbf{inférieur à 7}, $\approx 5,3$). Point de demi-équivalence visible à $10,0\ \text{mL}$, $\mathrm{pH} \approx 9,2$.
\item Au point de demi-équivalence ($V_E/2$), on a un mélange équimolaire acide/base conjuguée : $\mathrm{pH} = \mathrm{p}K_a$.
      \begin{itemize}
      \item Si $\mathrm{pH}_{1/2} \approx 4,8$ : c'est l'acide éthanoïque ($\mathrm{p}K_a = 4,8$).
      \item Si $\mathrm{pH}_{1/2} \approx 9,2$ : c'est l'ammoniac (car on dose \ce{NH3} par \ce{HCl}, le couple présent à la demi-éq est \ce{NH4+}/\ce{NH3} dont $\mathrm{p}K_a = 9,2$).
      \end{itemize}
      Cela permet de distinguer sans ambiguïté les deux espèces faibles.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Type Bac : vérification étiquette HCl]
\begin{enumerate}
\item \textbf{Schéma :} Bécher (ou erlenmeyer) posé sur agitateur magnétique (barrette). Électrode pH-métrique (verre + référence) plongée dans la solution, branchée sur pH-mètre. Burette graduée (classe B ou A) fixée au support, pointe immergée juste au-dessus du niveau liquide, contenant la solution de soude \SI{0,10}{M}. Volume initial noté. (Voir figure type ci-dessous).
      \begin{popfigure}
      \begin{center}
      \begin{tikzpicture}[scale=0.9, every node/.style={font=\small}]
      % Support
      \draw[popdark, thick] (0,0) -- (0,6) -- (5,6) -- (5,5.5);
      \draw[popdark, thick] (0,0) -- (-0.5,0) (5,0) -- (5.5,0);
      % Burette
      \draw[popblue, thick] (4.5,5.5) -- (4.5,1.5) -- (4.0,1.5) -- (4.0,1.0) -- (4.8,1.0) -- (4.8,1.5) -- (4.3,1.5) -- (4.3,5.5);
      \draw[popblue!50] (4.15,5.5) -- (4.15,1.5); % graduation
      \node[popblue, right] at (4.8, 4) {Burette : Soude \SI{0,10}{M}};
      \node[popblue, right] at (4.8, 3.5) {$V_{B,i}$};
      % Bécher
      \draw[popdark, thick] (1.5,0.5) -- (1.5,3) -- (3.5,3) -- (3.5,0.5);
      \draw[popdark, thick] (1.3,0.5) -- (1.5,0) -- (3.5,0) -- (3.7,0.5);
      \fill[popblue!20] (1.5,0.5) -- (1.5,2) -- (3.5,2) -- (3.5,0.5) -- cycle;
      \node[popdark, above] at (2.5, 3.2) {Bécher : $V_A = \SI{20,0}{mL}$ $S_1$};
      % pH-metre
      \draw[poppurple, thick] (2.5, 3) -- (2.5, 4.5) -- (1.0, 4.5) -- (1.0, 5.0);
      \draw[poppurple, thick, fill=poppurpleL] (0.5, 4.5) rectangle (1.5, 5.0) node[midway, font=\tiny] {pH-mètre};
      \draw[poppurple, thick] (2.5, 2.0) -- (2.5, 1.5) node[below] {Électrode};
      % Agitateur
      \draw[poporange, thick] (2.5, 0.2) circle (0.3) node[below] {Barrette};
      \draw[poporange, dashed] (2.5, 0.5) -- (2.5, 2.0);
      \end{tikzpicture}
      \end{center}
      \legende{Dispositif de dosage pH-métrique : titration de $S_1$ (acide) par la soude.}
      \end{popfigure}
\item \textbf{Équation-bilan :} $\ce{H3O+_{(aq)} + OH-_{(aq)} -> 2H2O_{(l)}}$.
      \textbf{Caractéristiques :} Réaction \textbf{totale} (avance jusqu'à épuisement d'un réactif), \textbf{rapide} (cinétique quasi instantanée), \textbf{exothermique} (dégagement de chaleur).
\item \textbf{Équivalence :} État du système où les quantités de matière des réactifs introduites sont dans les proportions stœchiométriques de l'équation-bilan : $n_{\ce{H3O+}}(\text{initial}) = n_{\ce{OH-}}(\text{versé à l'équivalence})$.
      \textbf{Méthode des tangentes parallèles :} On trace les tangentes aux deux branches lentes de la courbe (avant et après le saut) et la tangente à la branche verticale (point d'inflexion), parallèle aux deux premières. Les intersections de cette tangente centrale avec les deux autres se projettent sur l'axe des abscisses au volume équivalent $V_{BE}$.
\item \textbf{Calculs :}
      \begin{align*}
      n_{\ce{OH-}} &= C_B \times V_{BE} = 0,10 \times 16,0 \times 10^{-3} = \SI{1,60e-3}{mol} \\
      n_{\ce{H3O+}}(S_1) &= n_{\ce{OH-}} = \SI{1,60e-3}{mol} \quad (\text{stoechio 1:1}) \\
      C_A(S_1) &= \frac{n_{\ce{H3O+}}}{V_A} = \frac{1,60 \times 10^{-3}}{20,0 \times 10^{-3}} = \SI{0,080}{mol.L^{-1}} \\
      C_0(S_0) &= 100 \times C_A(S_1) = 100 \times 0,080 = \SI{8,0}{mol.L^{-1}}
      \end{align*}
\item \textbf{Non, l'étiquette n'est pas exacte.} La concentration réelle déterminée ($\SI{8,0}{mol.L^{-1}}$) est inférieure à la valeur indiquée ($\SI{10}{mol.L^{-1}}$). L'erreur relative est de 20\%.
\item \textbf{BBT et Phénolphtaléine.}
      \emph{Justification :} Pour un dosage fort/fort, $\mathrm{pH}_E = 7,0$. Le saut de pH est très large (environ 3 à 11).
      \begin{itemize}
      \item \textbf{BBT (6,0 -- 7,6)} : zone contenue dans le saut, contient $\mathrm{pH}_E = 7$. Virage jaune $\to$ bleu.
      \item \textbf{Phénolphtaléine (8,2 -- 10,0)} : zone contenue dans le saut (branche montante). Virage incolore $\to$ rose.
      \item Hélianthine (3,1 -- 4,4) : zone contenue dans le saut mais \textbf{ne contient pas} $\mathrm{pH}_E = 7$. Le virage aurait lieu \textbf{avant} l'équivalence (erreur systématique négative).
      \end{itemize}
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Type Bac : degré d'acidité vinaigre]
\begin{enumerate}
\item \textbf{Pourquoi diluer ?} Le vinaigre commercial est concentré ($\approx 0,8\text{--}1\ \text{M}$). Un dosage direct par une soude peu concentrée (\SI{0,020}{M}) nécessiterait un volume de titrant trop grand ($> 100\ \text{mL}$), dépassant la capacité de la burette et augmentant l'erreur relative. La dilution permet un volume équivalent commode ($\approx 10\text{--}25\ \text{mL}$).
      \textbf{Protocole (dilution 1/10) :} Pipette jaugée \SI{10,0}{mL} (ou \SI{25,0}{mL} ou \SI{50,0}{mL}) de vinaigre $\to$ Fiole jaugée \SI{100}{mL} (ou \SI{250}{mL} ou \SI{500}{mL}). Compléter à l'eau distillée jusqu'au trait de jauge. Homogénéiser. On obtient $S$ ($C_S = C_{\text{vinaigre}}/10$).
\item $\ce{CH3COOH_{(aq)} + OH-_{(aq)} -> CH3COO-_{(aq)} + H2O_{(l)}}$
\item \textbf{Tableau d'avancement à l'équivalence :}
      \begin{center}
      \begin{tabular}{|c|c|c|c|c|}
      \hline
      \rowcolor{popblueL} & $\ce{CH3COOH}$ & $\ce{OH-}$ & $\ce{CH3COO-}$ & $\ce{H2O}$ \\
      \hline État initial & $n_A$ & $n_B$ & 0 & --- \\
      \hline Équivalence & 0 & 0 & $n_A$ & --- \\
      \hline
      \end{tabular}
      \end{center}
      $n_{\ce{OH-}} = C_B V_{BE} = 0,020 \times 12,0 \times 10^{-3} = \SI{2,40e-4}{mol} = n_{\ce{CH3COOH}}(\text{dans } V_A)$.
      $C_A(S) = \dfrac{2,40 \times 10^{-4}}{10,0 \times 10^{-3}} = \SI{0,0240}{mol.L^{-1}}$.
      $C_{\text{vinaigre}} = 10 \times C_A(S) = \SI{0,240}{mol.L^{-1}}$.
\item Masse molaire $M = \SI{60}{g.mol^{-1}}$.
      $Masse dans 1 L = C \times M = 0,240 \times 60 = \SI{14,4}{g.L^{-1}}$.
      Masse volumique $\rho = \SI{1,0}{g.mL^{-1}} = \SI{1000}{g.L^{-1}}$.
      Degré d'acidité = $\dfrac{\text{masse acide dans 100 g vinaigre}}{100\ \text{g}} \times 100$ ? Non, définition : \textbf{masse en g dans 100 g de vinaigre}.
      Dans 100 g vinaigre (volume 100 mL), masse acide = $14,4 \times 0,100 = \SI{1,44}{g}$.
      \textbf{Degré d'acidité = $1,44^\circ$} (ou $1,4^\circ$ arrondi).
\item \textbf{L'étiquette « 5° » n'est pas exacte.} Le degré d'acidité mesuré ($1,44^\circ$) est très inférieur à $5^\circ$. Le vinaigre est fortement dilué ou l'étiquette est frauduleuse.
\item $\textbf{pH}_E = 8,6 > 7$ : À l'équivalence, seul l'acétate \ce{CH3COO-} reste. C'est une base (conjuguée d'un acide faible) : $\ce{CH3COO- + H2O <=> CH3COOH + OH-}$ $\Rightarrow$ milieu basique.
      $\textbf{pH}_{1/2} = \ce{pKa} = \textbf{4,8}$.
      \textbf{Indicateur : Phénolphtaléine} (zone 8,2 -- 10,0). Elle contient $\mathrm{pH}_E = 8,6$. Virage incolore $\to$ rose/violet. Le BBT (6,0--7,6) ne contient pas 8,6. L'hélianthine est acide.
\end{enumerate}
\end{corrige}
...
\begin{corrige}[Type Bac : dosage acide éthanoïque et pKa]
\begin{enumerate}
\item $\ce{CH3COOH_{(aq)} + OH-_{(aq)} -> CH3COO-_{(aq)} + H2O_{(l)}}$
\item \textbf{Lecture graphique :} Le point E (intersection des tangentes / point d'inflexion) a pour coordonnées : $V_{BE} = \SI{15,0}{mL}$ et $\mathrm{pH}_E = 8,7$.
      \textbf{Cohérence :} \textbf{Oui.} L'acide éthanoïque est un acide faible. À l'équivalence, la solution ne contient que son base conjuguée \ce{CH3COO-}, qui hydrolyse l'eau en libérant des ions \ce{OH-}. Le pH est donc \textbf{basique} ($> 7$), ce qui correspond à $\mathrm{pH}_E = 8,7$.
\item À l'équivalence : $n_{\ce{CH3COOH}} = n_{\ce{OH-}}$.
      $C_A V_A = C_B V_{BE} \Rightarrow C_A = \dfrac{C_B V_{BE}}{V_A} = \dfrac{0,10 \times 15,0}{20,0} = \SI{0,075}{mol.L^{-1}}$.
\item \textbf{Définition :} Le point de demi-équivalence correspond au volume $V_{B1/2} = V_{BE}/2$ pour lequel la demi-quantité d'acide initial a réagi. On a alors $[\ce{CH3COOH}] = [\ce{CH3COO-}]$.
      \textbf{Lecture graphique :} Point D : $V_{B1/2} = \SI{7,5}{mL}$, $\mathrm{pH}_{1/2} = 4,8$.
      \textbf{Déduction :} $\mathrm{p}K_a = \mathrm{pH}_{1/2} = \textbf{4,8}$.
      \textbf{Comparaison :} La valeur expérimentale (4,8) est \textbf{identique} à la valeur tabulée (4,8). La détermination est excellente.
\item $\mathrm{pH}_E = 8,7$. La zone de virage de la phénolphtaléine est [8,2 ; 10,0]. Elle \textbf{contient} le pH à l'équivalence. C'est donc un indicateur \textbf{bien choisi}.
      \textbf{Changement de teinte :} La solution est \textbf{incolore} avant l'équivalence (milieu acide/neutre) et devient \textbf{rose/violet} à l'équivalence (milieu basique).
\item $V_{B1/2} = V_{BE} / 2 = 15,0 / 2 = \SI{7,5}{mL}$.
      \textbf{Vérification graphique :} Le point D repéré sur le graphique a bien pour abscisse $7,5\ \text{mL}$. La cohérence est parfaite.
\end{enumerate}
\end{corrige}
