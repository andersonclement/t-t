...
\item Masse molaire $M = \SI{60}{g.mol^{-1}}$.
      Masse d'acide dans 1 L : $C \times M = 0,240 \times 60 = \SI{14,4}{g.L^{-1}}$.
      Masse volumique $\rho = \SI{1,0}{g.mL^{-1}} = \SI{1000}{g.L^{-1}}$.
      Définition : le degré d'acidité est la \textbf{masse (en g) d'acide éthanoïque contenue dans 100 g de vinaigre}.
