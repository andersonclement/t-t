% Acides forts et bases fortes — Chimie Tle C — Cours signé OnBuch+
...
\item Zone tampon ? Non, acide fort/base forte : pas de zone tampon. Le pH monte très lentement au début, puis très brutalement au voisinage de l'équivalence.
...
\begin{enumerate}
  ...
  \item $C_{\text{mère}} = \SI{1e-4}{M} < \SI{1e-6}{M}$ ? Non, $10^{-4} > 10^{-6}$, mère valide (pH=10).
