% Les solutions tampons — Chimie Tle D — Cours signé OnBuch+
...
\pagegarde{Les solutions tampons}{Chimie}{Tle D}{Module 2 · Acides et bases}{10}{2 h (cours + TP)}{Cette leçon définit les solutions tampons, solutions dont le pH varie peu par addition modérée d'acide, de base ou par dilution. Elle montre comment les préparer (mélange acide faible/base conjuguée, demi-neutralisation), comment calculer leur pH, comment repérer la zone tampon sur une courbe de dosage, et pourquoi elles sont indispensables en biologie, en médecine et dans l'industrie.
\vspace{4pt}
