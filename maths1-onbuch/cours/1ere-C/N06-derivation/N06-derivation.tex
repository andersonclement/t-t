% Dérivation — Mathématiques 1ère C — Cours signé OnBuch+
...
\pagegarde{Dérivation}{Mathématiques}{1ère C}{Relations et opérations fondamentales dans l'ensemble des nombres réels}{N06}{10 h}{Cette leçon introduit la notion fondamentale de nombre dérivé comme limite du taux d'accroissement, puis construit les outils de calcul des fonctions dérivées. Elle montre enfin comment la dérivée permet d'étudier les variations d'une fonction, de déterminer ses extrema et de tracer des tangentes à une courbe.
\vspace{4pt}
