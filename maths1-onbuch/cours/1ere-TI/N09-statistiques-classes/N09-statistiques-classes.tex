% Statistiques : séries regroupées en classes — Mathématiques 1ère TI — Cours signé OnBuch+
...
\pagegarde{Statistiques : séries regroupées en classes}{Mathématiques}{1ère TI}{Organisation et gestion des données}{N09}{5 h}{Cette leçon prolonge l'étude des séries statistiques au cas où les données sont regroupées en classes d'amplitude donnée. On y définit et calcule les paramètres de position (classe modale, mode, moyenne, médiane par interpolation linéaire) et de dispersion (écart moyen, variance, écart-type), ainsi que les représentations graphiques adaptées : histogramme et courbes cumulatives.
\vspace{4pt}
