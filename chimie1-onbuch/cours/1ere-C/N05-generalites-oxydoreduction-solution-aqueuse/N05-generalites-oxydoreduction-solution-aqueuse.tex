% Généralités sur l'oxydoréduction en solution aqueuse — Chimie 1ère C — Cours signé OnBuch+
...
\pagegarde{Généralités sur l'oxydoréduction en solution aqueuse}{Chimie}{1ère C}{Module 2 : Oxydoréduction}{05}{8 h}{Cette leçon introduit l'oxydoréduction en solution aqueuse à travers l'action des acides dilués sur les métaux et la réaction entre un ion métallique et un métal. Elle définit les notions d'oxydation, de réduction, d'oxydant et de réducteur, et apprend à écrire demi-équations électroniques et équations-bilans.
\vspace{4pt}
